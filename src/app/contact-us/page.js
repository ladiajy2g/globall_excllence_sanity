          ...
          <div className="flex flex-col gap-10">
            ...
            <div>
              ...
              <div className="flex gap-4">
                <a href="https://facebook.com/globalexcellence" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-gray-100 flex items-center justify-center hover:bg-brand-primary hover:text-white transition-colors rounded-sm">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z" />
                  </svg>
                </a>
                <a href="https://twitter.com/globalexcellence" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-gray-100 flex items-center justify-center hover:bg-brand-primary hover:text-white transition-colors rounded-sm">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2c9 5 20 0 20-11.5a4.5 4.5 0 00-.08-.83A7.72 7.72 0 0023 3z" />
                  </svg>
                </a>
                <a href="https://instagram.com/globalexcellence" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-gray-100 flex items-center justify-center hover:bg-brand-primary hover:text-white transition-colors rounded-sm">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href="https://youtube.com/@globalexcellence" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-gray-100 flex items-center justify-center hover:bg-brand-primary hover:text-white transition-colors rounded-sm">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
